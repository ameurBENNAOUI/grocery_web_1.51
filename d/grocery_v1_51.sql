...
--
-- Hôte : 127.0.0.1
-- Généré le :  sam. 19 déc. 2020 à 10:40
...
(1, 'Medcine', 'product/thump_1607594954.png'),
(2, 'Medcine dentaire', 'product/thump_1607594970.jpg'),
(3, 'Pharmacy', 'product/thump_1607594986.png');
...
--
-- Structure de la table `main_setting`
--
...
--
-- Déchargement des données de la table `main_setting`
--
...
--
-- Structure de la table `payment_list`
--
...
--
-- Déchargement des données de la table `payment_list`
--

INSERT INTO `payment_list` (`id`, `img`, `title`, `cred_title`, `cred_value`, `status`) VALUES
(1, 'payment/thump_1589451371.png', 'Razorpay', 'RAZORPAY_API_KEY', 'xxxxxxxxxx', 1),
(2, 'payment/thump_1589451385.png', 'Paypal', 'Sendbox', 'xxxxxxxx', 1),
...
INSERT INTO `product` (`id`, `pname`, `sname`, `cid`, `sid`, `sid_`, `psdesc`, `pgms`, `pprice`, `status`, `stock`, `pimg`, `prel`, `date`, `discount`, `popular`) VALUES
(1, 'detartrage', 'mab', 2, 2, '11', 'dfghjk\r\nsdfghjk\r\njjj', 'noir et blanc$;color', '40$;60', 1, 1, 'product/thump_1607595278.jfif', '', '2020-12-10 15:44:38', 0, 0),
(2, 'surfacage', 'fgff', 2, 2, '11', 'vcgffxgf', 'noir et blanc$;color', '35$;65', 1, 1, 'product/thump_1607595402.jpg', '', '2020-12-10 15:46:42', 0, 0),
(4, 'endo', 'mab', 2, 6, '11', 'fdgdd\r\ntft', 'noir et blanc$;color', '80$;100', 1, 1, 'product/thump_1607796190.jpg', '', '2020-12-12 23:33:10', 0, 0);

-- --------------------------------------------------------

--
-- Structure de la table `rate_order`
--
...
(4, 2, '1ere', 'product/thump_1607691993.png'),
(5, 2, '2eme', 'product/thump_1607692010.jpg'),
(6, 2, '3eme', 'product/thump_1607692022.png'),
(7, 2, '4eme', 'product/thump_1607692039.png'),
(8, 2, '5eme', 'product/thump_1607692052.png'),
(9, 2, '6eme', 'product/thump_1607692064.jpg');

-- --------------------------------------------------------

--
-- Structure de la table `subcategory_`
--

CREATE TABLE `subcategory_` (
  `id` int(11) NOT NULL,
  `cat_id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `subcategory_`
--

INSERT INTO `subcategory_` (`id`, `cat_id`, `subcat_id`, `name`, `catimg`) VALUES
(11, 2, '6', 'patho', 'product/thump_1607718808.jpg'),
(12, 2, '6', 'ODF', 'product/thump_1607718960.jfif'),
(14, 2, '6', 'Paro', 'product/thump_1607724366.png');
...
(1, 'mab', 'c4bd0196f60f20e2', 'm@m.m', '+213', '660465954', '2020-12-10 17:59:50', 'm', 1, NULL, 0);
...
--
-- Index pour la table `main_setting`
--
...
--
-- Index pour la table `payment_list`
--
...
--
-- Index pour la table `rate_order`
--
ALTER TABLE `rate_order`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `rider`
--
ALTER TABLE `rider`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `rnoti`
--
ALTER TABLE `rnoti`
  ADD PRIMARY KEY (`id`);
...
--
-- Index pour la table `subcategory_`
--
ALTER TABLE `subcategory_`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT pour la table `area_db`
--
ALTER TABLE `area_db`
...
--
-- AUTO_INCREMENT pour la table `main_setting`
--
ALTER TABLE `main_setting`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT pour la table `payment_list`
--
ALTER TABLE `payment_list`
...
--
-- AUTO_INCREMENT pour la table `rate_order`
--
ALTER TABLE `rate_order`
  MODIFY `id` int(8) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `rider`
--
ALTER TABLE `rider`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `rnoti`
--
ALTER TABLE `rnoti`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT pour la table `subcategory_`
--
ALTER TABLE `subcategory_`
...
--
-- AUTO_INCREMENT pour la table `uread`
--
ALTER TABLE `uread`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
